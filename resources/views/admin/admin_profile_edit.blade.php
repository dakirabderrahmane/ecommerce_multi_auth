           ...
           <div class="col-12">			
            ...
            <div class="row">
              ...
              <div class="col-md-6">		
                ...
                <img id="showImage"  src="{{ (!empty($editData->photo_profile_path))?url('upload/admin_images/'.$editData->photo_profile_path):url('upload/no_image.jpg')}}" style="width:100px;height:100px;">
